...
public class Pin extends JFrame implements ActionListener{
    ...
    Pin(String pin){
        ...
        l1.setBounds(230,270,800,35);
        l4.add(l1);
        
        l2.setBounds(150,330,150,35);
        l4.add(l2);
        
        l3.setBounds(150,380,200,35);
        l4.add(l3);
        
        t1.setBounds(320,330,180,25);
        l4.add(t1);
        
        t2.setBounds(320,380,180,25);
        l4.add(t2);
